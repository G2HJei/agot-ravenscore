...
public enum GameType {
	...
	public List<House> houses() {
		return switch (this) {
			case SECOND_EDITION -> List.of(STARK, GREYJOY, LANNISTER, TYRELL, MARTELL, BARATHEON);
			case A_DANCE_WITH_DRAGONS -> List.of(BOLTON, GREYJOY, LANNISTER, TYRELL, MARTELL, BARATHEON);
