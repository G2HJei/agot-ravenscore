...
public class RoutingConstants {
	...
	public static final String	REMOVE_STAGE			= UPSERT_STAGE + "/remove/{stageId}";
	public static final String	SUBSTITUTE_PLAYER		= UPSERT_STAGE + "/{stageId}/participant/{participantId}/substitute/{substituteId}";
